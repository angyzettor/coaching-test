...
\
# Interface Streamlit\
st.title("\uc0\u55358 \u56598  Coach IA Personnel et Professionnel")\
...
\
# Saisie utilisateur\
user_input = st.text_input("\uc0\u55357 \u56492  Votre question :")\
\
if user_input:\
    response = coaching_response(user_input)\
    st.write(f"\uc0\u55357 \u56481  R\'e9ponse du Coach IA : \{response\}")\
}